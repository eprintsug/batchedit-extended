...
EPrints::Plugin::Export::ZoraBatchEdit
This is a custom version of the standard EPrints BatchEdit Export Plugin.
It has been modified to use an enhanced batch edit screen plugin rather than the standard plugin.

=cut

package EPrints::Plugin::Export::ZoraBatchEdit;
